...
$db['write']['hostname'] = '10.105.1.15';
$db['write']['username'] = 'ora_w';
$db['write']['password'] = 'mariokart8';
...
$db['read']['hostname'] = '10.105.1.15';
$db['read']['username'] = 'ora_r';
$db['read']['password'] = 'supersmashbros';
