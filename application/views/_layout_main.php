...
<body <?php echo !empty($body_attr)?$body_attr:''; ?>>
    <div style="display:none;">
        <div id="appinfo" username="<?php echo (!empty($this->userinfo['username']))?$this->userinfo['username']:''; ?>" baseurl="<?php echo $this->base_url; ?>" include-path="<?php echo $this->include_path; ?>"></div>
        ...
        <div class="modal fade" id="oracleModal_comfirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
